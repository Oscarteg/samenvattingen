...
route: /hogeschool-leiden/kwaliteit-in-de-it
...
![V-model](./iqua/images/v-model.jpg)
...
![Soorten projecten](./iqua/images/soort-project.png)
...
### History
![A Brief History of Software Developement Processes](./iqua/images/a-brief-history-of-software-developement-processes.jpg)

![History Software Development Methologies](./iqua/images/history-software-development-methologies.png)
...
![Extreme programming](./iqua/images/extreme-programming.png)
...
![Soorten processen](./iqua/images/soorten-processen.jpg)
...
![Soorten processen](./iqua/images/processen-soorten.jpg)
...
![INK model](./iqua/images/ink-model.jpg)
...
![INK model fasen](./iqua/images/ink-model-fasen.jpg)


![INK model & PDCA](./iqua/images/ink-model-pdca.jpg)

# IMWR en PCDA

![IMWR en PCDA](./iqua/images/imwr-pdca.png)
...
![House of Lean](./iqua/images/house-of-lean.png)
...
![Lean flow before](./iqua/images/lean-flow-before.gif)

![Lean flow after](./iqua/images/lean-flow-after.gif)
...
![Value stream map](./iqua/images/value-stream-map.jpg)
...
![Lean six sigma](./iqua/images/lean-six-sigma.png)
...
![Lean Six Sigma Belt](./iqua/images/lean-six-sigma-belts.jpg)
...
![Lean Six Sigma DMAIC](./iqua/images/lean-six-sigma-dmaic.png)
...
![All PRINCE2 components](./iqua/images/prince2-components.gif)
...
![PRINCE2 process model](./iqua/images/prince2-process-model.png) 
...
![PRINCE2 samengevat](./iqua/images/prince2-samengevat.png)
...
## Maturity model
![Maturity Model](./iqua/images/cobit-maturity-model.png)
